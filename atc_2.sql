...
INSERT INTO `dili_admins` (`uid`, `username`, `password`, `email`, `role`) VALUES
	...
	(2, 'dahuangfeng', 'de9f6bc24ccc080c10a7c25f8cf937ff', 'dahuangfeng@163.com', 2);
...
# Dumping data for table atc.dili_model_fields: 6 rows
...
# Dumping data for table atc.dili_sessions: 1 rows
...
# Dumping data for table atc.dili_u_m_repairs: 0 rows
DELETE FROM `dili_u_m_repairs`;
